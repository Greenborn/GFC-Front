...
### **1.20.67** (Agosto de 2026)



### **1.20.66** (Agosto de 2026)



### **1.20.65** (Agosto de 2026)



### **1.20.64** (Agosto de 2026)



### **1.20.63** (Agosto de 2026)



### **1.20.62** (Agosto de 2026)



### **1.20.61** (Agosto de 2026)



### **1.20.60** (Agosto de 2026)



### **1.20.59** (Agosto de 2026)



### **1.20.58** (Agosto de 2026)



### **1.20.57** (Agosto de 2026)



### **1.19.57** (Agosto de 2026)



### **1.19.56** (Agosto de 2026)



### **1.19.55** (Agosto de 2026)

- Eliminada la consulta de jueces del listado de concursos (`/#/concursos`). El acceso a juzgamiento queda solo dentro del detalle del concurso
- Corregido envío de `unique_id` de sesión en `ContestJudgeService` para las consultas por `contest_id`

### **1.19.54** (Agosto de 2026)

- Script de actualización de versión (`scripts/bump-version.js`) que sincroniza `package.json`, README, `.env` y `environment*.ts`
- Corregido número de versión mostrado en el menú (APP_VERSION desactualizado en `.env`)

### **1.19.53** (Julio 2026)

- Agregado botón de cámara en avatar del topbar y sidebar para cambiar foto de perfil
- Modal selector de imagen con preview, cámara web en desktop y captura nativa en mobile
